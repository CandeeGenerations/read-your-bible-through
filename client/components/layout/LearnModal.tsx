                  ...
                  <div className="mt-5">
                    ...
                    <ul className="list-disc list-inside">
                      <li className="text-sm text-gray-500">
                        Read <strong>2 Old Testament chapters</strong> and{' '}
                        <strong>1 New Testament chapter</strong>
                      </li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside">
                      <li className="text-sm text-gray-500">
                        Read <strong>3 Old Testament chapters</strong> and{' '}
                        <strong>2 New Testament chapters</strong>
                      </li>
                    </ul>
                    ...
                    <p className="text-sm text-gray-500 mt-10">
                      When you complete the New Testament near the end of the
                      summer, add the amount of chapters you would read to your
