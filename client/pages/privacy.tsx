    ...
    <Layout>
      ...
      <div className="mt-24">
        ...
        <p className="my-5 text-lg text-secondary-600">
          Thank you for visiting our website. We understand that privacy is
          important to you, and we are committed to protecting your personal
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          address, when you fill out our contact form or sign up for our
          newsletter. We may also collect non-personal information, such as your
          IP address and browser type, to help us improve our website and
          services.
        </p>
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          <br />
          We will only use your personal information to respond to your
          inquiries, send you our newsletter if you have subscribed to it, and
          improve our website and services. We will never sell or share your
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          unauthorized access, disclosure, and use. However, no data
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          are small files that are stored on your computer or mobile device when
          you visit our website. They help us remember your preferences and
          understand how you use our website. You can disable cookies in your
