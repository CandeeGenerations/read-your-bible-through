    ...
    <Layout>
      ...
      <div className="mt-24">
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          and software, is the property of our website or its content suppliers
          and is protected by international copyright laws. You may not copy,
          distribute, modify, or create derivative works of any content on this
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          else&apos;s use and enjoyment of the website. You are prohibited from
          engaging in any conduct that could damage, disable, or impair our
          website or interfere with any other user&apos;s use of our website.
        </p>
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          completeness, or timeliness of any information on our website. We are
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          or in connection with your use of our website, including but not
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          owned or controlled by us. We are not responsible for the content or
          privacy practices of these websites. We encourage you to review the
          terms of service and privacy policies of any third-party websites you
          visit.
        </p>
        ...
        <p className="my-5 text-lg text-secondary-600">
          ...
          <br />
          We may modify these terms of service at any time. You are responsible
          for regularly reviewing these terms. Your continued use of our website
